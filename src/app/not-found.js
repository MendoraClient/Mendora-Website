...
export default function NotFound() {
  ...
  return (
    <>
      <div className="mt-4 min-h-screen bg-gradient-to-br from-[#232323] via-[#281a13] to-[#393939] text-white flex items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center px-6 relative z-10 max-w-2xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-zinc-300 text-lg leading-relaxed">
              ...
              moved. Don&apos;t worry, even the best explorers get lost
              sometimes!
            </p>
          </div>
          ...
          <div className="bg-zinc-800/50 rounded-xl p-6 border border-zinc-700/50 backdrop-blur-sm mb-8">
            <div className="flex items-center justify-center gap-3 mb-3">
              ...
              <span className="font-mono text-red-400 uppercase tracking-wide">
                Connection Lost
              </span>
            </div>
            <p className="text-zinc-400 font-mono text-sm">
              Unable to connect to requested resource. Please check your
              navigation or return to spawn point.
            </p>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-zinc-700/50">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/about"
                className="text-green-400 hover:text-green-300 font-mono text-sm hover:underline transition"
              >
                About
              </Link>
              <Link
              ...
              <a
                ...
                className="text-blue-400 hover:text-blue-300 font-mono text-sm hover:underline transition"
              >
                Discord
              </a>
            </div>
